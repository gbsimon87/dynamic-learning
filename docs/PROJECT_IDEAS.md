...
- Curriculum Mode has challenges for **3 of 39 Year 2 Maths topics** — filling
  the remaining 36 topics is the single largest body of outstanding work.
...
| 20 | **Complete Year 2 Maths curriculum** | Build challenges 1–4 for the remaining 36 Year 2 Maths topics (place value, addition/subtraction, multiplication/division, fractions, measurement, geometry, statistics). Biggest single body of work; unlocks the whole curriculum path. *Counting in Steps of 2, 3, 5 and 10* was built 2026-09-18 as the pilot for the shared challenge kit (`src/components/challenge/`); subsequent topics should compose that kit rather than copy a challenge, and are expected to bend it as new interactions appear. | 🟡 Partial (3/39 topics) |
